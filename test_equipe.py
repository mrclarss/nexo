...
def test_criar_participant(team_id):
...
team_id = test_criar_equipe()

test_listar_equipe()

if team_id:
    test_criar_participant(team_id)
    test_participants_by_team(team_id)

test_invalid_team()
test_listar_participants()
test_validation()
